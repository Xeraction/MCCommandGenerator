...
namespace MCCommandGenerator
{
    partial class SelectorA
    {
        ...
        /// <summary>
        /// Required method for Designer support - please modify
        ...
        private void InitializeComponent()
        {
            ...
            this.helpProvider1.SetHelpString(comboBox2, "Sets the advancement the player needs to have.\nSelect true if the player should have the advancement.\nSelect false otherwise.");
            ...
            // textBox9
            //
            this.helpProvider1.SetHelpString(textBox9, "The XP-Level the player should have.\nSelect \"From closest\" to start at 0.\n(The value in this box will then be ignored)");
            ...
            // textBox10
            //
            this.helpProvider1.SetHelpString(textBox10, "The maximum XP-Level the player should have.\nLeave it blank for a specific amount.\nSelect \"To infinite\" to end at infinity.\n(The value in this box will then be ignored)");
            ...
            // textBox11
            //
            this.helpProvider1.SetHelpString(textBox11, "The maximum amount of players to select.");
            ...
            // textBox13
            //
            this.helpProvider1.SetHelpString(textBox13, "The start range of the x-rotation of the player.\nSelect \"From closest\" to start at 0.\n(The value in this box will then be ignored)");
            ...
            // textBox14
            //
            this.helpProvider1.SetHelpString(textBox14, "The start range of the y-rotation of the player.\nSelect \"From closest\" to start at 0.\n(The value in this box will then be ignored)");
            ...
            // textBox15
            //
            this.helpProvider1.SetHelpString(textBox15, "The end range of the x-rotation of the player.\nLeave it blank for a specific value.\nSelect \"To infinite\" to end at infinity.\n(The value in this box will then be ignored)");
            ...
            // textBox16
            //
            this.helpProvider1.SetHelpString(textBox16, "The end range of the y-rotation of the player.\nLeave it blank for a specific value.\nSelect \"To infinite\" to end at infinity.\n(The value in this box will then be ignored)");
            ...
            // textBox17
            //
            this.helpProvider1.SetHelpString(textBox17, "The NBT-data of the player.\nA custom NBT-Editor will come in future versions.");
            ...
            this.button1.Click += new EventHandler(MCCommandGenerator.SelectorControl.SelectorASave);
            //
            // button2
            //
            ...
            this.button2.Click += new EventHandler(MCCommandGenerator.SelectorControl.SelectorACancel);
            //
            // button3
            //
            ...
            this.button3.Click += new EventHandler(MCCommandGenerator.SelectorControl.SelectorAReset);
            //
            // label20
            //
            ...
            // textBox18
            //
            this.helpProvider1.SetHelpString(textBox18, "The predicate(s) the player should have.\nA custom Predicate-Editor will come in the future.");
            ...
            // textBox19
            //
            this.helpProvider1.SetHelpString(textBox19, "The scores of the player.\nA custom Score-Editor will come in the future.");
            ...
            this.helpProvider1.SetHelpString(comboBox4, "Sorts the players you want to select.\nnearest - The player nearest to the executing entity\nfurthest - The player furthest away from the executing entity\nrandom - A random player\narbitrary - No sorting at all");
